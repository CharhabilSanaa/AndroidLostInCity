 ...
 */
public class LocationService implements com.charhabil.android.lostincity.data.PlacesServiceApi {
  ...
  private Map<String, com.charhabil.android.lostincity.data.Place> mCachedPlaces = null;
  ...
  @Override public List<com.charhabil.android.lostincity.data.Place> getPlacesFromRepo() {
  ...
  private static List<com.charhabil.android.lostincity.data.Place> filterPlaces(final List<com.charhabil.android.lostincity.data.Place> foundPlaces){
    final Collection<com.charhabil.android.lostincity.data.Place> placesToRemove = new ArrayList<>();
    final List<String> selectedTypes = CategoryKeeper.getInstance().getSelectedTypes();
    if (!selectedTypes.isEmpty()){
      for (final com.charhabil.android.lostincity.data.Place p: foundPlaces) {
  ...
  private class GeocodeProcessor implements Runnable{
    ...
    @Override public void run() {
      ...
      try {
        ...
        final List<com.charhabil.android.lostincity.data.Place> places = new ArrayList<>();
        int i = 0;
        for (final GeocodeResult r: data){
          ...
          final com.charhabil.android.lostincity.data.Place place = new com.charhabil.android.lostincity.data.Place(name, type, location, address, url,phone,null,0);
  ...
  private void setBearingAndDistanceForPlace(final com.charhabil.android.lostincity.data.Place place){
    String bearing =  null;
  ...
  public final Envelope getResultEnvelope(){
    if (mCurrentEnvelope == null){
      ...
      final List<com.charhabil.android.lostincity.data.Place> places = getPlacesFromRepo();
      if (places != null && !places.isEmpty()){
        final List<Point> points = new ArrayList<>();
        for (final com.charhabil.android.lostincity.data.Place place : places){
